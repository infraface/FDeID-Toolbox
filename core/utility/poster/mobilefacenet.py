"""
MobileFaceNet for POSTER model.

Used for extracting facial landmark features.
"""
...
class MobileFaceNet(Module):
    """MobileFaceNet for facial landmark feature extraction."""
    ...
    def forward(self, x):
        ...
        out = self.output_layer(conv_features)  # [B, embedding_size]
