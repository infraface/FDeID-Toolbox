...
from core.identity.yolo5face.utils.common import Conv, Bottleneck, SPP, DWConv, Focus, BottleneckCSP, C3, ShuffleV2Block, Concat, NMS, autoShape, StemBlock, BlazeBlock, DoubleBlazeBlock
from core.identity.yolo5face.utils.experimental import MixConv2d, CrossConv
from core.identity.yolo5face.utils.data_ops import check_anchor_order, make_divisible
from core.identity.yolo5face.utils.general import check_file, set_logging
from core.identity.yolo5face.utils.torch_utils import time_synchronized, fuse_conv_and_bn, model_info, scale_img, initialize_weights, select_device, copy_attr
...
class Model(nn.Module):
    def __init__(self, cfg='./core.identity.yolo5face/model/yolo5face.yaml', ch=3, nc=None):  # model, input channels, number of classes
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./core.identity.yolo5face/model/yolo5face.yaml', help='model.yaml')
